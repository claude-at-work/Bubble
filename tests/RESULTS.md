...
_Run: 2026-04-27T02:55:05 — 7 passed, 0 failed, 0 skipped._
...
```
vault_db: /tmp/bubble-test-dn8g_hz2/vault.db
...
`10_breakers/test_empty_script_fetches_nothing.py` — 23 ms
...
`10_breakers/test_late_alias_does_not_corrupt_earlier.py` — 32 ms
...
module id stable:  0x7f6ed9db18a0 → 0x7f6ed9db18a0
class id stable:   0x2e67740 → 0x2e67740
STATE dicts distinct: old@0x7f6ed9dc0900 vs new@0x7f6ed9dc0c40
...
`10_breakers/test_top_level_index_bridges_import_to_dist.py` — 32 ms

```
distribution name: Carbohydrate-9000
top-level import:  sugar
top_level row:     ('Carbohydrate-9000', '3.0.0', 'sugar')
resolved module:   /tmp/bubble-test-nphxdh1e/vault/Carbohydrate-9000/3.0.0/py3-none-any/sugar/__init__.py
...
`10_breakers/test_two_versions_one_process.py` — 35 ms

```
widget_old.Widget: id=0x46482a0
widget_new.Widget: id=0x4649370
...
`30_loop/test_failure_recording_round_trip.py` — 16 ms
...
```
probed_at: 2026-04-27T02:55:05.841040
