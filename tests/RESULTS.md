...
_Run: 2026-04-27T09:20:51 — 11 passed, 0 failed, 0 skipped._

---

## ✓ a fresh BUBBLE_HOME yields a usable vault DB on schema v2

`00_sanity/test_vault_initializes.py` — 30 ms

```
vault_db: /tmp/bubble-test-1rhtxoqj/vault.db
...
`10_breakers/test_empty_script_fetches_nothing.py` — 36 ms
...
`10_breakers/test_fetcher_refuses_off_host_url.py` — 76 ms
...
`10_breakers/test_late_alias_does_not_corrupt_earlier.py` — 31 ms
...
module id stable:  0x7ff1a9fe8270 → 0x7ff1a9fe8270
class id stable:   0x18ecad90 → 0x18ecad90
STATE dicts distinct: old@0x7ff1a9c0f9c0 vs new@0x7ff1a9c0fd00
...
`10_breakers/test_top_level_carries_content_hash.py` — 32 ms
...
`10_breakers/test_top_level_contention_logged.py` — 25 ms
...
resolved module:   /tmp/bubble-test-3slbhd20/vault/Carbohydrate-9000/3.0.0/py3-none-any/sugar/__init__.py
...
`10_breakers/test_two_versions_one_process.py` — 23 ms

```
widget_old.Widget: id=0x518f4d0
widget_new.Widget: id=0x518fbb0
...
`30_loop/test_failure_recording_round_trip.py` — 52 ms
...
`30_loop/test_probe_writes_host_toml.py` — 19 ms

```
probed_at: 2026-04-27T09:20:51.113939
