...
_Run: 2026-04-27T07:25:12 — 7 passed, 0 failed, 0 skipped._

---

## ✓ a fresh BUBBLE_HOME yields a usable vault DB on schema v2

`00_sanity/test_vault_initializes.py` — 32 ms

```
vault_db: /tmp/bubble-test-7x7zzkol/vault.db
...
`10_breakers/test_empty_script_fetches_nothing.py` — 37 ms
...
module id stable:  0x7ff9aabe1760 → 0x7ff9aabe1760
class id stable:   0x33a0d720 → 0x33a0d720
STATE dicts distinct: old@0x7ff9aabecb80 vs new@0x7ff9aabecec0
...
`10_breakers/test_top_level_index_bridges_import_to_dist.py` — 28 ms

```
distribution name: Carbohydrate-9000
top-level import:  sugar
top_level row:     ('Carbohydrate-9000', '3.0.0', 'sugar')
resolved module:   /tmp/bubble-test-vr8lsylm/vault/Carbohydrate-9000/3.0.0/py3-none-any/sugar/__init__.py
...
```
widget_old.Widget: id=0x34120140
widget_new.Widget: id=0x34121210
...
`30_loop/test_failure_recording_round_trip.py` — 36 ms
...
`30_loop/test_probe_writes_host_toml.py` — 30 ms

```
probed_at: 2026-04-27T07:25:12.027282
